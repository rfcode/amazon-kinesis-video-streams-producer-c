                                               ...
                                               STATUS statusCode)
{
    ...
    if (!(IS_RETRIABLE_PRODUCER_ERROR(statusCode) || IS_RETRIABLE_COMMON_LIB_ERROR(statusCode))) {
        ...
        //
        // MM - My code is _maybe_ not necessary, but I'm leaving it here
        // commented out in case I want to add it back
        //

        // MM - My code
        //CHK(IS_RECOVERABLE_ERROR(statusCode), STATUS_SUCCESS);
        ...
        // MM - My code
        //CHK(IS_RETRIABLE_ERROR(statusCode), statusCode);
